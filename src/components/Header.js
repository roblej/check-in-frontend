      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-14">
          <div className="flex items-center gap-8">
            <Link
              href="/"
              className="text-2xl font-bold text-[#3B82F6] cursor-pointer hover:text-blue-600 transition-colors"
            >
              체크인
            </Link>
            <nav className="hidden md:flex items-center gap-6">
              ...
              <a
                href="/admin"
                className="text-sm font-semibold text-[#3B82F6] hover:text-blue-600 transition-colors"
              >
                관리자
              </a>
              <a
                href="/master"
                className="text-sm font-semibold text-[#7C3AED] hover:text-purple-600 transition-colors"
              >
                마스터
              </a>
            </nav>
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              href={isClient && isInlogged() ? "/" : "/login"}
              onClick={isClient && isInlogged() ? handleLogout : ""}
